...
exports.ROBOCORP_UPLOAD_ROBOT_TO_CLOUD = "robocorp.uploadRobotToCloud"; // Upload Robot to the Control Room
...
exports.ROBOCORP_UPLOAD_TO_NEW_ROBOT_INTERNAL = "robocorp.uploadToNewRobot.internal"; // Uploads a Robot as a new Robot in the Control Room
exports.ROBOCORP_UPLOAD_TO_EXISTING_ROBOT_INTERNAL = "robocorp.uploadToExistingRobot.internal"; // Uploads a Robot as an existing Robot in the Control Room
...
exports.ROBOCORP_NEW_ROBOCORP_INSPECTOR_BROWSER = "robocorp.newRobocorpInspectorBrowser"; // Add Browser Locator
...
exports.ROBOCORP_CLOUD_UPLOAD_ROBOT_TREE_SELECTION = "robocorp.cloudUploadRobotTreeSelection"; // Upload Robot to Control Room
...
exports.ROBOCORP_LIST_WORK_ITEMS_INTERNAL = "robocorp.listWorkItems.internal"; // Lists the work items available for a Robot
exports.ROBOCORP_UPDATE_LAUNCH_ENV = "robocorp.updateLaunchEnv"; // Updates the environment variables used for some launch (given a Robot)
...
exports.ROBOCORP_CONNECT_VAULT = "robocorp.connectVault"; // Connect to online secrets vault
exports.ROBOCORP_DISCONNECT_VAULT = "robocorp.disconnectVault"; // Disconnect from online secrets vault
exports.ROBOCORP_GET_CONNECTED_VAULT_WORKSPACE_INTERNAL = "robocorp.getConnectedVaultWorkspace.internal"; // Gets workspace id of the currently connected vault
exports.ROBOCORP_SET_CONNECTED_VAULT_WORKSPACE_INTERNAL = "robocorp.setConnectedVaultWorkspace.internal"; // Sets the currently connected vault workspace
